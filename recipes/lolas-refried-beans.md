---
title: Lola's Refried Beans
description: Creamy, from-scratch refried beans simmered with lard, blended smooth with an immersion blender, and finished with plenty of shredded Monterey Jack.
contributor: Lola
course: side
cuisine: Mexican
tags: [beans, pinto, cheese]
image:
  src: ./images/lolas-refried-beans/hero.jpg
  alt: A large pot of creamy, freshly blended refried beans being stirred with a ladle on a stainless-steel counter.
servings: 16
ingredients:
  - qty: 2
    unit: lb
    item: dried pinto beans
    note: "typically one large grocery store bag"
    grams: 907
    gramsSource: "2 lb = 907 g (453.6 g/lb)"
  - qty: 0.5
    unit: cup
    item: lard
    grams: 110
    gramsApprox: true
    gramsSource: "lard ≈ 0.92 g/ml (½ cup ≈ 118 ml)"
  - item: salt
    note: "to taste, added at the start"
  - item: water
    note: "for boiling"
  - qty: 0.75
    unit: lb
